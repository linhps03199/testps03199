...
Public Class frmQLSP
    ...
    Dim chuoiketnoi As String = "Server=.;Database=TEST;Integrated Security=True"
    ...
    Private Sub LoadData()
        ...
        db.Clear()
        refesh.Fill(db)
        dgvQL.DataSource = db.DefaultView
        conn.Close()
    End Sub
    Private Sub reset()
        txtDongia.Text = ""
    ...
    Private Sub btnSua_Click(sender As Object, e As EventArgs) Handles btnSua.Click
        ...
        End If
    End Sub
    Private Sub dgvQL_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvQL.CellContentClick
        Dim click As Integer = dgvQL.CurrentCell.RowIndex
        txtMaSP.Text = dgvQL.Item(0, click).Value
        txtTenSP.Text = dgvQL.Item(1, click).Value
        txtSoluong.Text = dgvQL.Item(2, click).Value
        txtDongia.Text = dgvQL.Item(3, click).Value
